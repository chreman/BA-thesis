...
; price calculation
; scaling (size of patches)
; refine rainfall model ( l / m³ )
; add supply via rivers and calculate take out to satisfy demand
...
; In the final version it should calculate water demand based on price.
;________________________________________________________________________________
...
;________________________________________________________________________________
  ...
  set price (sum [demand] of irrigations - sum [water] of irrigations) / metric-patch-size / metric-patch-size * 2 + 10
end
@#$#@#$#@
GRAPHICS-WINDOW
200
