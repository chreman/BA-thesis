...
; set crop-list ["alfalfa" "corn" "apple" "peach"]
  set crop-list [0 1 2 3]
  set crop-demand-list [352 287 133 227] ; water demand m³/hectar per week
  set crop-productivity-list [0.052 0.1 1 0.74] ; € / m³
end
