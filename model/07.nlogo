...
;________________________________________________________________________________
  ...
  set irrigation-area gis:load-dataset "data/irrigations.shp"
  set irrigation-centroids gis:load-dataset "data/irrigation-centroids.shp"
  set cities gis:load-dataset "data/cities.shp"
  set popcores gis:load-dataset "data/popcores.shp"
  set catchments-area gis:load-dataset "data/catchments.shp"
  set catchment-centroids gis:load-dataset "data/catchment-centroids.shp"
...
<experiments>
  <experiment name="baselines" repetitions="5" runMetricsEveryStep="true">
    ...
    <metric>report-boolean drought?</metric>
